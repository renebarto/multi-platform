...
//
//template<class T>
//bool Compare(const T * expected, int offsetExpected,
...
//
//template<class T>
//bool Compare(const T * expected, const T * actual, int numSamples)
//{
...
//
//template<class T>
//bool Compare(const T * const * expected, int offsetExpectedRows, int offsetExpectedCols,
...
//
//template<class T>
//bool Compare(const T * const * expected, const T * const * actual, int numRows, int numCols)
//{
