...
TEST_FIXTURE(IPV6EndPointTest, PrintToNoPort)
{
    ...
    string expected = _("102:304:506:708:90a:b0c:d0e:f10%2");
    basic_ostringstream<OSAL::Char> stream;
    endPoint.PrintTo(stream);
    EXPECT_EQ(expected, stream.str());
}
...
TEST_FIXTURE(IPV6EndPointTest, PrintToNoScopeID)
{
    ...
    string expected = _("[102:304:506:708:90a:b0c:d0e:f10]:1234");
    basic_ostringstream<OSAL::Char> stream;
    endPoint.PrintTo(stream);
    EXPECT_EQ(expected, stream.str());
}
...
TEST_FIXTURE(IPV6EndPointTest, PrintTo)
{
    ...
    string expected = _("[102:304:506:708:90a:b0c:d0e:f10]:1234%2");
    basic_ostringstream<OSAL::Char> stream;
    endPoint.PrintTo(stream);
    EXPECT_EQ(expected, stream.str());
}
...
TEST_FIXTURE(IPV6EndPointTest, PrintToNonMemberNoScopeID)
{
    ...
    EXPECT_EQ(_("[102:304:506:708:90a:b0c:d0e:f10]:1234"), stream.str());
}
...
TEST_FIXTURE(IPV6EndPointTest, PrintToNonMember)
{
    ...
    basic_ostringstream<OSAL::Char> stream;
    PrintTo(endPoint, stream);
    EXPECT_EQ(_("[102:304:506:708:90a:b0c:d0e:f10]:1234%2"), stream.str());
}
