...
#ifndef REMOTINGTS1_SERVERNODE_H
#define REMOTINGTS1_SERVERNODE_H

#include "dispatcher.h"
#include "remoting1/ipaddress.h"

namespace Remoting1 { class Cipher; }
namespace RemotingTs1 {

using Remoting1::Cipher;
class IEventLoop;
 ...
 */
class REMOTING_EXPORT ServerNode : private Dispatcher
{
public:
	...
	*/
	 ...
	 */
	Remoting1::IpAddress address(void) const;

	/*! Returns the network mask of the bound interface.
	 */
	Remoting1::IpAddress netmask(void) const;
	...
	*/
	virtual Remoting1::BulkChannel & bulkChannel() override final;
...
public:
    ...
    {
        return providesType(hostId, _interface::_remoting_name);
    }
    ...
    {
        return createInstance(hostId, _interface::_remoting_name);
    }
    ...
    {
        return createInstance(hostId, _interface::_remoting_name, instance);
    }
    ...
    void registerSingleton(_type *singleton)
    {
        ...
        singleton->_remoting_register(*this, singleton_instance);
    }
    ...
    void registerInstance(_type *singleton, const std::string &instance)
    {
        ...
        singleton->_remoting_register(*this, instance);
    }
...
private:
    ...
    virtual void sendNotification(const std::vector<std::string> &hostIds, const std::vector<Remoting1::BulkChannel::BulkId> &, const std::string &instance, const char *path, Message &in) override final;
