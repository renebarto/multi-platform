...
#ifndef REMOTINGTS1_EVENT_H
#define REMOTINGTS1_EVENT_H
...
class REMOTING_EXPORT EventBase
{
...
protected:
	...
	struct REMOTING_EXPORT Lock { Lock(void *); Lock(const Lock &); ~Lock(); void unlock(); mutable void *m; };
	Lock lock() const;
 ...
 */
class REMOTING_EXPORT Event0 : public Event<void()>
{
public:
...
/*! A helper class that can be used to subscribe to events, it will
    ...
    \endcode
 */
class REMOTING_EXPORT EventHandler
{
