...
#ifndef REMOTINGTS1_BULKDATA_H
#define REMOTINGTS1_BULKDATA_H
 ...
 */
class BulkData : public Remoting1::BulkChannel::Buffer
{
public:
	...
	BulkData(const Remoting1::BulkChannel::Buffer &c) noexcept;
	BulkData & operator=(const BulkData &);
	BulkData & operator=(const Remoting1::BulkChannel::Buffer &);
