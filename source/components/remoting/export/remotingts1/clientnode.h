...
#ifndef REMOTINGTS1_CLIENTNODE_H
#define REMOTINGTS1_CLIENTNODE_H
 ...
 */
class REMOTING_EXPORT ClientNode : private Dispatcher
{
public:
...
public:
    ...
    {
        return providesType(_interface::_remoting_name);
    }
    ...
    {
        return createInstance(_interface::_remoting_name);
    }
    ...
    {
        return createInstance(_interface::_remoting_name, instance);
    }
