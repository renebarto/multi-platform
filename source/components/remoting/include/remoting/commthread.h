...
#ifndef REMOTING1_COMMTHREAD_H
#define REMOTING1_COMMTHREAD_H
...
#  error REMOTING requires Windows Vista SDK or later; set _WIN32_WINNT >= 0x600
# endif
# undef min
# undef max
# ifdef MSC_VER
...
public:
    ...
    /*! The server ID in the form of: "<OS name> <UPnP version> <REMOTING version>".
     */
