    ...
    , xmlOutput()
{
    ...
    group->AddOptionRequiredArgument("gtest_filter", 0,
                                     "Google test filter expression (currently only used to switch to google test emulation)", testFilter);
    group->AddOptionRequiredArgument("gtest_color", 0,
                                     "Google test color output (currently only used to switch to google test emulation)", testColor);
