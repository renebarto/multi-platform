...
constexpr const char * BinaryDigits = "01";
constexpr const char * OctalDigits = "01234567";
constexpr const char * DecimalDigits = "0123456789";
constexpr const char * DecimalDigitsPlus = "0123456789+";
constexpr const char * DecimalDigitsPlusMinus = "0123456789+-";
constexpr const char * HexaDecimalDigits = "0123456789ABCDEF";
constexpr const char * FloatingPointChars = "0123456789.+-Ee";
constexpr const char * BooleanTrueLiteral = "true";
constexpr const char * BooleanFalseLiteral = "false";
