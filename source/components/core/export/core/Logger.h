...
public:
    ...
    void Error(const std::string & componentName, const std::string & message, const std::exception & exception);
    void Warn(const std::string & componentName, const std::string & message);
    void Warn(const std::string & componentName, const std::string & message, const std::exception & exception);
...
protected:
    ...
    void Log(const std::string & componentName, LogLevel logLevel, const std::string & message, const std::exception * exception = nullptr);
