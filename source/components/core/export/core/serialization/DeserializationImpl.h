...
CORE_EXPORT bool Deserialize(const OSAL::ByteArray & text, bool & value);
CORE_EXPORT bool Deserialize(const OSAL::ByteArray & text, int8_t & value, int base = 10);
CORE_EXPORT bool Deserialize(const OSAL::ByteArray & text, uint8_t & value, int base = 10);
CORE_EXPORT bool Deserialize(const OSAL::ByteArray & text, int16_t & value, int base = 10);
CORE_EXPORT bool Deserialize(const OSAL::ByteArray & text, uint16_t & value, int base = 10);
CORE_EXPORT bool Deserialize(const OSAL::ByteArray & text, int32_t & value, int base = 10);
CORE_EXPORT bool Deserialize(const OSAL::ByteArray & text, uint32_t & value, int base = 10);
CORE_EXPORT bool Deserialize(const OSAL::ByteArray & text, int64_t & value, int base = 10);
CORE_EXPORT bool Deserialize(const OSAL::ByteArray & text, uint64_t & value, int base = 10);
CORE_EXPORT bool Deserialize(const OSAL::ByteArray & text, float & value);
CORE_EXPORT bool Deserialize(const OSAL::ByteArray & text, double & value);
CORE_EXPORT bool Deserialize(const OSAL::ByteArray & text, long double & value);
//#if !defined(WIN_MSVC)
