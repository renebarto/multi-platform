...
class CommandLineSwitchTest : public UnitTestCpp::TestFixture
{
public:
    virtual void SetUp();
...
void CommandLineSwitchTest::SetUp()
{
}

void CommandLineSwitchTest::TearDown()
{
}
...
TEST_FIXTURE(CommandLineSwitchTest, Construction)
{
...
TEST_FIXTURE(CommandLineSwitchTest, ConstructionOptionFoundFlag)
{
...
TEST_FIXTURE(CommandLineSwitchTest, ConstructionArgType)
{
...
TEST_FIXTURE(CommandLineSwitchTest, ConstructionOptionFoundFlagArgType)
{
//    OSAL::String textValue(_("Text"));
...
TEST_FIXTURE(CommandLineSwitchTest, GetSet)
{
//    CommandLineOption option(LongName, ShortName, Description, ArgType);
//
...
TEST_FIXTURE(CommandLineSwitchTest, FoundOption)
{
//    CommandLineOption option(LongName, ShortName, Description, ArgType);
//
//    option.LongName(LongName2);
...
TEST_FIXTURE(CommandLineSwitchTest, Value)
{
//    CommandLineOption option(LongName, ShortName, Description, ArgType);
//
