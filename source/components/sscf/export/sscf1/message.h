...
#ifndef SSCF1_MESSAGE_H
#define SSCF1_MESSAGE_H
...
#if defined(_M_CEE) || defined(SSCF1_MESSAGE_CPP) // For C++/CLI <vector> gives LNK4210; these methods are replacements
