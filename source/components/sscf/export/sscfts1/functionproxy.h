...
#ifndef SSCFTS1_FUNCTIONPROXY_H
#define SSCFTS1_FUNCTIONPROXY_H
...
public:
    ...
    inline static void proxy0(Sscf1::BulkChannel &bulkChannel, const Message &, Message &out, _ret(_object::* fptr)(), _object *obj)
    {
        _ret ret = (obj->*fptr)();
		...
		const std::vector<Sscf1::BulkChannel::BulkId> &bulkIds = serializer.bulkIds();
		bulkChannel.addRecipients(!bulkIds.empty() ? &bulkIds[0] : nullptr, bulkIds.size());
	}

    template <class _object, typename _prm1>
    inline static void proxy1(Sscf1::BulkChannel &bulkChannel, const Message &in, Message &out, _ret(_object::* fptr)(_prm1 &), _object *obj)
    {
    ...
    inline static void proxy2(Sscf1::BulkChannel &bulkChannel, const Message &in, Message &out, _ret(_object::* fptr)(_prm1 &, _prm2 &), _object *obj)
    {
		Formatter::Deserializer deserializer(in.content(), &bulkChannel);
        _prm1 prm1 = parameter(deserializer, reinterpret_cast<_prm1 *>(NULL));
    ...
    inline static void proxy3(Sscf1::BulkChannel &bulkChannel, const Message &in, Message &out, _ret(_object::* fptr)(_prm1 &, _prm2 &, _prm3 &), _object *obj)
    {
		Formatter::Deserializer deserializer(in.content(), &bulkChannel);
        _prm1 prm1 = parameter(deserializer, reinterpret_cast<_prm1 *>(NULL));
        _prm2 prm2 = parameter(deserializer, reinterpret_cast<_prm2 *>(NULL));
    ...
    inline static void proxy4(Sscf1::BulkChannel &bulkChannel, const Message &in, Message &out, _ret(_object::* fptr)(_prm1 &, _prm2 &, _prm3 &, _prm4 &), _object *obj)
    {
		Formatter::Deserializer deserializer(in.content(), &bulkChannel);
        _prm1 prm1 = parameter(deserializer, reinterpret_cast<_prm1 *>(NULL));
        _prm2 prm2 = parameter(deserializer, reinterpret_cast<_prm2 *>(NULL));
    ...
    inline static void proxy5(Sscf1::BulkChannel &bulkChannel, const Message &in, Message &out, _ret(_object::* fptr)(_prm1 &, _prm2 &, _prm3 &, _prm4 &, _prm5 &), _object *obj)
    {
		Formatter::Deserializer deserializer(in.content(), &bulkChannel);
        _prm1 prm1 = parameter(deserializer, reinterpret_cast<_prm1 *>(NULL));
        _prm2 prm2 = parameter(deserializer, reinterpret_cast<_prm2 *>(NULL));
...
public:
	template <class _object>
    inline static void proxy0(Sscf1::BulkChannel &, const Message &, Message &, void(_object::* fptr)(), _object *obj)
    {
        (obj->*fptr)();
    }

    template <class _object, typename _prm1>
    inline static void proxy1(Sscf1::BulkChannel &bulkChannel, const Message &in, Message &out, void(_object::* fptr)(_prm1 &), _object *obj)
    {
		Formatter::Deserializer deserializer(in.content(), &bulkChannel);
        _prm1 prm1 = parameter(deserializer, reinterpret_cast<_prm1 *>(NULL));
    ...
    template <class _object, typename _prm1, typename _prm2>
    inline static void proxy2(Sscf1::BulkChannel &bulkChannel, const Message &in, Message &out, void(_object::* fptr)(_prm1 &, _prm2 &), _object *obj)
    {
		Formatter::Deserializer deserializer(in.content(), &bulkChannel);
        _prm1 prm1 = parameter(deserializer, reinterpret_cast<_prm1 *>(NULL));
        _prm2 prm2 = parameter(deserializer, reinterpret_cast<_prm2 *>(NULL));
    ...
    template <class _object, typename _prm1, typename _prm2, typename _prm3>
    inline static void proxy3(Sscf1::BulkChannel &bulkChannel, const Message &in, Message &out, void(_object::* fptr)(_prm1 &, _prm2 &, _prm3 &), _object *obj)
    {
		Formatter::Deserializer deserializer(in.content(), &bulkChannel);
        _prm1 prm1 = parameter(deserializer, reinterpret_cast<_prm1 *>(NULL));
        _prm2 prm2 = parameter(deserializer, reinterpret_cast<_prm2 *>(NULL));
    ...
    template <class _object, typename _prm1, typename _prm2, typename _prm3, typename _prm4>
    inline static void proxy4(Sscf1::BulkChannel &bulkChannel, const Message &in, Message &out, void(_object::* fptr)(_prm1 &, _prm2 &, _prm3 &, _prm4 &), _object *obj)
    {
		Formatter::Deserializer deserializer(in.content(), &bulkChannel);
        _prm1 prm1 = parameter(deserializer, reinterpret_cast<_prm1 *>(NULL));
        _prm2 prm2 = parameter(deserializer, reinterpret_cast<_prm2 *>(NULL));
    ...
    template <class _object, typename _prm1, typename _prm2, typename _prm3, typename _prm4, typename _prm5>
    inline static void proxy5(Sscf1::BulkChannel &bulkChannel, const Message &in, Message &out, void(_object::* fptr)(_prm1 &, _prm2 &, _prm3 &, _prm4 &, _prm5 &), _object *obj)
    {
		Formatter::Deserializer deserializer(in.content(), &bulkChannel);
        _prm1 prm1 = parameter(deserializer, reinterpret_cast<_prm1 *>(NULL));
        _prm2 prm2 = parameter(deserializer, reinterpret_cast<_prm2 *>(NULL));
