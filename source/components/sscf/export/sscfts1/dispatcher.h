...
#ifndef SSCFTS1_DISPATCHER_H
#define SSCFTS1_DISPATCHER_H
...
public:
    ...
    {
        registerInterface(_type::_sscf_name, instance, nullptr, nullptr, nullptr);
    }
    ...
    {
        unregisterInterface(instance, _interface::_sscf_name);
    }
	...
	/*! Executes the specified function for all items. If one of the functions
		enters a blocking wait for a response from an SSCF client or server it
...
protected:
    ...
    virtual void sendNotification(const std::vector<std::string> &hostIds, const std::vector<Sscf1::BulkChannel::BulkId> &, const std::string &instance, const char *path, Message &in) = 0;
    ...
    typedef void(* ProxyFunc)(Sscf1::BulkChannel &, const Message &, Message &, ProxyFuncPtr, void *);
    ...
    {
        object->_sscf_register(*this, empty);
    }
    ...
    inline bool createObjectFunc(IMultitonFactory<_type> *factory, const std::string &instance, _type *&object)
    {
        ...
        if (object)
        {
            object->_sscf_register(*this, instance);
            return true;
        }
	...
	_ret(_object::* fptr)(), _object *obj)
{
	return registerProxy(
        ...
        ProxyFunc(&::SscfTs1::FunctionProxy<_ret>::template proxy0<_object>),
	...
	_ret(_object::* fptr)(_prm1 &), _object *obj)
{
	return registerProxy(
		clientHostId, instance, path,
        ProxyFunc(&::SscfTs1::FunctionProxy<_ret>::template proxy1<_object, _prm1>),
		ProxyFuncPtr(fptr), obj);
}
	...
	_ret(_object::* fptr)(_prm1 &, _prm2 &), _object *obj)
{
	return registerProxy(
		clientHostId, instance, path,
        ProxyFunc(&::SscfTs1::FunctionProxy<_ret>::template proxy2<_object, _prm1, _prm2>),
		ProxyFuncPtr(fptr), obj);
}
	...
	_ret(_object::* fptr)(_prm1 &, _prm2 &, _prm3 &), _object *obj)
{
	return registerProxy(
		clientHostId, instance, path,
        ProxyFunc(&::SscfTs1::FunctionProxy<_ret>::template proxy3<_object, _prm1, _prm2, _prm3>),
		ProxyFuncPtr(fptr), obj);
}
	...
	_ret(_object::* fptr)(_prm1 &, _prm2 &, _prm3 &, _prm4 &), _object *obj)
{
	return registerProxy(
		clientHostId, instance, path,
        ProxyFunc(&::SscfTs1::FunctionProxy<_ret>::template proxy4<_object, _prm1, _prm2, _prm3, _prm4>),
		ProxyFuncPtr(fptr), obj);
}
	...
	_ret(_object::* fptr)(_prm1 &, _prm2 &, _prm3 &, _prm4 &, _prm5 &), _object *obj)
{
	return registerProxy(
		clientHostId, instance, path,
        ProxyFunc(&::SscfTs1::FunctionProxy<_ret>::template proxy5<_object, _prm1, _prm2, _prm3, _prm4, _prm5>),
		ProxyFuncPtr(fptr), obj);
}
...
{
	Sscf1::BulkChannel &bulkChannel = this->bulkChannel();
...
class Dispatcher { virtual Sscf1::BulkChannel &bulkChannel() = 0; };
