...
function(add_uninstall_target MAIN_TARGET)
    configure_file(
        ${CMAKE_CURRENT_SOURCE_DIR}/uninstall.cmake.in
        ${CMAKE_CURRENT_BINARY_DIR}/uninstall.cmake
        IMMEDIATE @ONLY)

    add_custom_target(uninstall_${PACKAGE_NAME}
        COMMAND ${CMAKE_COMMAND} -DCOMPONENT=${PACKAGE_NAME} -P ${CMAKE_CURRENT_BINARY_DIR}/uninstall.cmake
        DEPENDS ${PACKAGE_NAME}
        COMMENT "Uninstalling ${PACKAGE_NAME}")
    add_dependencies(${MAIN_TARGET} uninstall_${PACKAGE_NAME})
endfunction()

function(add_install_target MAIN_TARGET)
    add_custom_target(install_${PACKAGE_NAME}
        COMMAND ${CMAKE_COMMAND} -DCOMPONENT=${PACKAGE_NAME} -P ${CMAKE_BINARY_DIR}/cmake_install.cmake
        DEPENDS ${PACKAGE_NAME}
        COMMENT "Installing ${PACKAGE_NAME}")
    add_dependencies(${MAIN_TARGET} install_${PACKAGE_NAME})
endfunction()
